...
plt.xlim(0, len(log_data)*40)
```
是因為我拿1200個資料下去做DFT，會產生600個結果 (剩下600-1200個資料是對稱的，所以只存前600)，然後我要將x軸顯示0-24000Hz，所以用這每隔40個放一次資料的方法來實現。  
...
然後是他們對應的YL、YR log spectrum，可以看出相對於 M = 1024的情況，YL的低頻(<1500Hz)過濾效果更不好，YR的中頻(1500-3500Hz)也不如 M=1024 時的平整，整體來看過濾效果更不好：
<div class="32_y">
